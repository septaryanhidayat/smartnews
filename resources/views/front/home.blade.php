                            ...
                            <article class="slide-card">
                                <div class="slide-card__img-wrap">
                                    <a href="{{ route('article.show', $slide->slug) }}" aria-label="{{ $slide->title }}">
                                        <img class="slide-card__img" src="{{ $slide->image_url }}" alt="{{ $slide->title }}" width="500" height="300" {!! $loop->first ? 'fetchpriority="high" loading="eager" decoding="sync"' : 'loading="lazy" decoding="async"' !!} onerror="this.src='{{ asset('images/default-news.webp') }}'">
                                    </a>
